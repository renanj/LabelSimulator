					...
					if _file_name !='df_'+ _list_train_val[i_train_val] + '.pkl':
						...
						for _i_outcome in range(len(_results_output[0])):
							...
							_temp_df = pd.DataFrame(
								list(zip(_pd_list_0, _pd_list_1, _pd_list_2, _pd_list_3, _pd_list_4, _pd_list_5 ,_pd_list_7,_pd_list_8, _pd_list_9))
								,columns=["Outcome", "Interaction", "Database", "DL Architecture", "Simulation Type", "Model", "# Samples Evaluated/Interaction Number","Accuracy_test", "Accuracy_validation"]
